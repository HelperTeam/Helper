...
import com.help.helper.net.request.constant.NetBaseConstant;
...
public class HttpTool {
    ...
    public static String Login(String phone, String password) {
        ...
        String data = "phone="+phone+"&password="+password + "&token=helper";
        String result = "";
    ...
    public static String AppRegister(String phone,String code,String password){
        ...
        String data = "phone="+phone+"&password="+password+"&code="+code+"&devicestate=2&token=helper";
        String result = "";
        result = getResponse(url,data);
        return  result;
    }
    ...
    public static String ForgetPassword(String phone,String code,String password){
        String url = NetBaseConstant.NET_API_HOST + "a=forgetpwd&";
        String data = "phone="+phone+"&password="+password+"&code="+code+"&token=helper";
        String result = "";
        result = getResponse(url,data);
        return result;
    }
